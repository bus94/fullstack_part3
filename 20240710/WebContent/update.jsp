	...
	<form action="updateOK.jsp" method="post">
		<table width="600" align="center" border="1" cellpadding="5"
			...
			<tr>
				...
				<td width="500"><input id="name" type="text" name="name" value="${post.name}">
				</td>
				<%-- <th width="100">이름</th>
			...
			<tr>
				...
				<td><textarea id="memo" rows="10" name="memo"
						style="resize: none; width: 98%;">${post.memo}</textarea></td>
				<%-- <th>메모</th>
		...
		<%-- <input type="hidden" name="updatepost" value="${updatepost}" /> --%>
