	...
	<form action="insertOK.jsp" method="post">
		<table width="600" align="center" border="1" cellpadding="5"
			...
			<tr>
				...
				<td width="500"><input id="name" type="text" name="name" /></td>
			</tr>
			<tr>
